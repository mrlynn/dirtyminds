      ...
      channel.bind('client-gm-finish-voting', (data) => {
        ...
        setVotes((currentVotes) => {
          ...
          setPlayers((currentPlayers) => {
            ...
            console.log('Correct votes by answer:', correctVotes);
            console.log('Funniest votes by answer:', funniestVotes);

            // Find winners (only if there are votes)
            ...
            console.log('Winners - Correct:', correctWinnerId, 'Funniest:', funniestWinnerId);
            ...
            const updatedPlayers = currentPlayers.map((p) => {
              ...
              if (p.role === 'SAINT' && p.id === correctWinnerId) {
                newScore += 1;
                console.log(`Awarding point to ${p.name} (SAINT) for most correct votes`);
              }

              // Sinner wins if they got most "funniest" votes
              if (p.role === 'SINNER' && p.id === funniestWinnerId) {
                newScore += 1;
                console.log(`Awarding point to ${p.name} (SINNER) for most funniest votes`);
              }
              ...
              if (p.role === 'SINNER' && p.id === correctWinnerId && p.id === funniestWinnerId) {
                ...
                console.log(`Bonus point to ${p.name} (SINNER) for winning both categories!`);
              }
